                ...
                success:function(data, textStatus, xhr)
                {
                    if(data.state === 1 && data.product)
                    {
                        ...
                        for (var i = 0; i < len; ++i)
                        {
                            ...
                            ajaxhistoryRec.currentDate = ajaxhistoryRec.currentDate.setDate(ajaxhistoryRec.currentDate.getDate() - 1);
                        }
...
function infoTapHandler($info)
{
    ...
    window.location.href = ajaxhistoryRec.detailUrl + "?resId=" + resId;
}
