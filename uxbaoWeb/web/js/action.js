...
console.log(phoneData.downloadList.length);
console.log(phoneData.updateList.length);
console.log(phoneData.installList.length);
/*var phoneData = {
                    "downloadList":
                    [
                        {
...
$(function()
{
    ...
    if(document.getElementById("slide_01"))
    {
        ...
        slide_01.frameWidth = $(document).width();
        slide_01.pageWidth = $(document).width();
